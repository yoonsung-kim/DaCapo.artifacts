...
# OrinLow-Ekya	OrinHigh-Ekya	DaCapo-Ekya	OrinHigh-EOMU	DaCapo-Spatial	DaCapo-Spatiotemporal	RTX3090-CL
NAME_DICT = {
...
if __name__ == "__main__":
    ...
    # make summary file
    summary_dir = Path(summary_root / "figure_9")
    summary_dir.mkdir(parents=True, exist_ok=True)
    summary_file = summary_dir / "figure_9-sheet.csv"
