...
class Config:
    def __init__(self, config_file_path: str):
        ...
        self.infer_batch_size: int = None # only for fast emulation, inference batch is 1 due to live streaming of input images
        ...
        self.label_device: torch.device = None
        self.infer_device: torch.device = None
        self.profile_device: torch.device = None
...
if __name__ == "__main__":
    cfg_path = "/home/yskim/projects/bfp-continual-learning.code/emulator/config/example.json"
    config = Config(config_file_path=cfg_path)
